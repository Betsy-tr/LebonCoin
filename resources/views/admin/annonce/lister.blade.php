    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{route('admin.annonce.edit', $itemAnnonce->id)}}" class="font-serif text-blue-600 dark:text-blue-500 hover:underline ">
                ...
                <td class="px-6 py-4">
                    ...
                    <a href="{{route('admin.annonce.delete', $itemAnnonce->id)}}" class="font-serif text-blue-600 dark:text-blue-500 hover:underline">
